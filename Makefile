...
envtest:
	...
	@echo "$(PACKER_JSON)"
	@echo "$(RANCHEROS_NET_ETH1_ADDRESS)"
	@echo "$(RANCHEROS_NET_ETH1_GATEWAY)"
	@echo "$(RANCHEROS_NET_ETH1_MTU)"
	@echo "$(RANCHEROS_NET_NAMESERVER_1)"
	@echo "$(RANCHEROS_NET_NAMESERVER_2)"
	@echo "$(RANCHEROS_NET_DOMAIN_1)"
	@echo "$(RANCHEROS_NET_DOMAIN_2)"
